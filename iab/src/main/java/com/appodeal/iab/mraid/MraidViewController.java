...
public class MraidViewController implements MraidCommandListener, MraidViewabilityTracker.MraidViewabilityListener {
    private final static String TAG = "MraidViewController";
    ...
    @VisibleForTesting public MraidViewControllerListener mraidViewControllerListener;
    ...
    public static MraidViewController createInlineController(@NonNull Context context, @NonNull MraidView mraidView) {
    ...
    public static MraidViewController createInterstitialController(@NonNull Context context) {
        MraidScreenMetrics mraidScreenMetrics = new MraidScreenMetrics(ViewHelper.getDensity(context));
        ...
        this.onLayoutChangeListener = new View.OnLayoutChangeListener() {
            ...
            public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
                ...
                if (orientation != lastOrientation) {
                    ...
                    Logger.d(TAG, String.format("Orientation changed: %s", lastOrientation == Configuration.ORIENTATION_PORTRAIT ? "portrait" : "landscape"));
    ...
    public void setMraidViewControllerListener(MraidViewControllerListener mraidViewControllerListener) {
    ...
    public FrameLayout getMraidView() {
        return mraidView;
    }
    ...
    public void onResize(MraidResizeProperties resizeProperties) throws MraidError {
        ...
        Logger.d(TAG, String.format("Max size: %s", mraidScreenMetrics.getMaxSize()));
        Logger.d(TAG, String.format("Resized rect: %s", resizeRect));
        ...
        Logger.d(TAG, String.format("Close button rect: %s", closeButtonRect));
    ...
    public void onUnload() {
        ...
        Logger.d(TAG, "Unload called, destroy controller");
        if (mraidViewControllerListener != null) {
            mraidViewControllerListener.onMraidViewControllerUnloaded(this);
        }
        destroy();
    ...
    public void onOpen(String url) {
        ...
        if (mraidNativeFeatureManager != null) {
            ...
            Logger.d(TAG, "Native feature listener is null");
        }
    }
