...
class Icon implements ResourceHolder {
    ...
    public String getClickThrough() {
        return iconClicks.getClickThrough();
    }
    ...
    boolean viewIsLoaded() {
        return mraidViewController != null && mraidViewController.isLoaded();
    }

    View getView(Context context, final ResourceViewHelper.ResourceListener listener) {
        mraidViewController = ResourceViewHelper.createViewController(context, this, listener);
        mraidViewController.load();
        int viewWidth = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, width, context.getResources().getDisplayMetrics());
        int viewHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, height, context.getResources().getDisplayMetrics());
