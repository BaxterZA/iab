...
class VastModel {
            ...
            if (nodes != null) {
                for (int i = 0; i < nodes.getLength(); i++) {
                    ...
                    try {
                        ...
                        Logger.d(TAG, String.format("Event: %s is not valid. Skipping it.", eventName));
                        continue;
                    }
        ...
        try {
            ...
            if (nodes != null) {
                if (nodes.getLength() == 0) {
                    try {
                        sendError(com.appodeal.iab.vast.Error.ERROR_CODE_COMPANION_NODE_NOT_FOUND);
                    } catch (Exception ex) {
                        Logger.e(TAG, ex);
                    }
                } else {
    ...
    List<MediaFile> getInteractiveCreativeFiles() {
        Logger.d(TAG, "getInteractiveCreativeFile");
                                        ...
                                        if (name.equals(EXTENSION_NAME_COMPANION)) {
                                            ...
                                            switch (name) {
                                                ...
                                                case EXTENSION_NAME_MUTE_YPOSITION:
                                                    ...
                                                    break;
                                                default:
                                                    Logger.d(TAG, String.format("Extension %s is not supported", name));
                                            }
                                        }
                                    }
    ...
    List<String> getViewableViewableImpression() {
        Logger.d(TAG, "getViewableViewableImpression");
    ...
    List<String> getNotViewableViewableImpression() {
        Logger.d(TAG, "getNotViewableViewableImpression");
    ...
    List<String> getViewUndeterminedViewableImpression() {
        Logger.d(TAG, "getViewUndeterminedViewableImpression");
