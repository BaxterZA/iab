...
public class CloseableLayout extends FrameLayout {
    ...
    static Rect getCloseButtonRect(ClosePosition closePosition, Rect resizeRect) {
    ...
    void startTimer(final int timeInMills, final int currentPosition) {
