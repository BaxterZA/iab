...
public class MraidActivity extends Activity implements MraidViewControllerListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (mraidInterstitial == null) {
            MraidLog.e(String.format("Mraid interstitial with id %s not found", interstitialId));
            finish();
            return;
        }

        if (mraidInterstitial.isDestroyed()) {
            MraidLog.e(String.format("Mraid interstitial with id %s was destroyed", interstitialId));
            finish();
            return;
        }
        ...
        if (mraidViewController == null) {
            MraidLog.e("Mraid controller not found");
            closeActivity();
            return;
        }
